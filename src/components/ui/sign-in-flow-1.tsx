  ...
  return (
    <div className={cn("flex w-[100%] flex-col min-h-screen bg-black relative", className)}>
      ...
      <div className="relative z-10 flex flex-col flex-1">
        <div className="w-full flex justify-center absolute top-12 left-0 right-0 z-50">
          <img src="/logo.gif" alt="Site Logo" className="h-[200px] w-auto object-contain drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]" />
        </div>
        <div className="flex flex-1 flex-col lg:flex-row ">
          <div className="flex-1 flex flex-col justify-start items-center pt-[280px]">
                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-6 md:space-y-8">
                      <h1 className="text-[3.5rem] md:text-[4.5rem] font-bold leading-[1.1] tracking-tight text-white whitespace-nowrap drop-shadow-xl">Welcome Homies</h1>
                      <p className="text-[1.8rem] md:text-[2.5rem] text-white/80 font-light drop-shadow-md">Make Your Texts Into QR Codes</p>
                    </div>
                    
                    <div className="pt-[192px] md:pt-[256px] flex justify-center w-full">
                      <div className="inline-flex -space-x-px divide-x divide-black/10 rounded-xl shadow-[0_0_20px_rgba(255,255,255,0.1)] rtl:space-x-reverse min-w-[320px]">
                        <Button
                          className="rounded-none bg-white/5 hover:bg-white/10 text-white shadow-none first:rounded-s-xl last:rounded-e-xl focus-visible:z-10 border border-white/10 backdrop-blur-md"
                          size="iconLg"
                          aria-label="QR code"
                        >
